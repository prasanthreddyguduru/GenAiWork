# AIBees Academy Knowledge Assistant
import os
import json
import base64
...
# User avatar: professional person silhouette in AIBees dark/orange
USER_AVATAR_SVG = """
...
# Assistant avatar: stylized bee in AIBees orange
...
def build_prompt(context: str, history: list[dict], question: str) -> list[dict]:
    system_message = {
        ...
        "content": (
            ...
            "Answer learner and staff questions using the provided document context. "
            "Be concise, warm, encouraging, and professional — in the spirit of AIBees Academy. "
...
<div class="aibees-header">
    <img src="data:image/svg+xml;base64,{logo_b64}" width="140" alt="AIBees Logo"/>
    <div class="aibees-header-text">
        <h1>Knowledge <span>Assistant</span></h1>
        <p>🐝 Incremental RAG &nbsp;·&nbsp; Gemini 2.5 Flash &nbsp;·&nbsp; FAISS &nbsp;·&nbsp; AIBees Academy</p>
    </div>
</div>
...
if not st.session_state.db:
    ...
    ">
        ...
        <h3 style="color: #E8500A; margin: 10px 0 6px 0;">Welcome to AIBees Knowledge Assistant</h3>
...
# Chat input
user_query = st.chat_input("Ask the AIBees Knowledge Assistant anything…")
